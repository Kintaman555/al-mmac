...
#define NETSTACK_CONF_RDC     al_mmac_driver //xmac_driver//contikimac_driver //
...
#define CC2420_CONF_AUTOACK              0 //1
...
#define COLLECT_NEIGHBOR_CONF_MAX_COLLECT_NEIGHBORS     8
